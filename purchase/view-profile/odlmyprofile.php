    ...
    <form class="form-horizontal form-material row rowpaddingless " action="/controller/ktp-upload.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12 col-lg-12 verTOPnew rowpaddingless">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="<?php echo $dataUser['mobilePhone']; ?>" class="form-control form-control-line" value="<?php echo $dataUser['mobilePhone']; ?>" name="mobilePhone">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Alamat Domisili 1</label>
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="<?php echo $dataUser['lineAddress1']; ?>" class="form-control form-control-line" value="<?php echo $dataUser['lineAddress1']; ?>" name="lineAddress1">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Alamat Domisili 2</label>
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="<?php echo $dataUser['lineAddress2']; ?>" class="form-control form-control-line" value="<?php echo $dataUser['lineAddress2']; ?>" name="lineAddress2">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Kode Pos Domisili</label>
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="<?php echo $dataUser['postalCode']; ?>" class="form-control form-control-line" value="<?php echo $dataUser['postalCode']; ?>" name="postalCode">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">No. Telp Rumah</label>
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="<?php echo $dataUser['homePhone']; ?>" class="form-control form-control-line" value="<?php echo $dataUser['homePhone']; ?>" name="homePhone">
                                                </div>
                                            </div>
                                        <!-- TO BE CONFIRMED -->
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="hanwhasourceincome" required>
                                                    <option value="<?php echo $dataUser['incomeSource']; ?>" selected>
                                                        <?php 
                                                            if($dataUser['incomeSource'] == "SLR"){
                                                                echo "Gaji";
                                                            }else if($dataUser['incomeSource'] == "INV"){
                                                                echo "Hasil Investasi";
                                                            }else if($dataUser['incomeSource'] == "SHU"){
                                                                echo "Hasil Usaha";
                                                            }else if($dataUser['incomeSource'] == "WRS"){
                                                                echo "Warisan";
                                                            }else if($dataUser['incomeSource'] == "INCOTH"){
                                                                echo "Lainnya";
                                                            }
                                                        ?>
                                                    </option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <button class="btn btn-success" type="submit" name="profileupdate">Perbarui Profil</button>
                                        </div>
                                    </div>
                                </form>
    </div>   