...
if(isset($_GET['setplan']) && $_GET['setplan'] != NULL){
    ...
    curl_setopt_array($curl, array(
      CURLOPT_PORT => "8080",
      CURLOPT_URL => "http://192.168.0.220:8080/hanwhaservices/product/collect?skip=0&max=10",
                  ...
                  <div class="col-md-12 col-12 align-self-center">
                    <div class="step" style="margin-bottom: 2%">
                        <div class="row" style="padding: 0px !important; margin: 0px !important; display: -webkit-box;">
                            ...
                            <div class="col-lg-10 col-md-12 col-12 displayDesktop" src="../assets/images/form/steps/Hanwhalife-bucketlist-step-02.png" width="100%"><img src="../assets/images/form/steps/Hanwhalife-bucketlist-step-02.png" width="100%"></div>
                        </div>
                        <img src="../assets/images/form/steps/Hanwhalife-bucketlist-step-02.png" width="100%" class="displayMobile">
