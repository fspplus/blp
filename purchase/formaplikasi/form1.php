	    ...
	    <div class="col-md-12 col-12 align-self-center">
	      <div class="row">
	      	<div class="col-md-12 col-12 align-self-center judul">
		    	<div class="step" style="margin-bottom: 2%">
                    <img src="../assets/images/form/steps/Hanwhalife-bucketlist-step-01.png" width="100%">
	      ...
	      <div class="row" style="margin-top: 30px">
	        ...
	        <div id = "colL" class="col-lg-6 col-md-12 noPads animated fadeInLeft">
	          <a href="#!" onclick="planfnc('pla')"><img src="../assets/images/hanwhauserasset/Hanwhalife-bucketlist-plan-A.jpg" style="width: 100%; border-radius: 20px"></a>
	        </div>
	        <div id = "colR" class="col-lg-6 col-md-12 animated fadeInRight">
	          <a href="#!" onclick="planfnc('plb')"><img src="../assets/images/hanwhauserasset/Hanwhalife-bucketlist-plan-B.jpg" style="width: 100%; border-radius: 20px"></a>
	        </div>
	      </div>
	    </div>
	  </div>
