...
<div class="row animated fadeIn">
	      ...
	      <div id = "colL" class="col-lg-6 col-md-12">
	        ...
	        Email Ahli Waris
	        <input type="email" class="txedit" name="emailbenef<?php echo $ctrBenef; ?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
	        Phone Number
	        <input type="tel" class="txedit" name="telbenef<?php echo $ctrBenef; ?>" pattern="[0-9]*" maxlength="12" required>
	        Jenis Kelamin
