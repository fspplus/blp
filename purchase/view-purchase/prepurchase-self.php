<?php 
    ...
    $_SESSION['dataForm1']['hanwhaname'] = $user_data['fullName'];
    $_SESSION['dataForm1']['hanwhaemail'] = $user_data['emailAddress'];
    $_SESSION['dataForm1']['hanwhaphone'] = $user_data['mobilePhone'];
    $_SESSION['dataForm1']['hanwhanik'] = "";
    $_SESSION['dataForm1']['hanwhadob'] = "";
    $_SESSION['dataForm1']['hanwhaHomephone'] = "";
    $_SESSION['dataForm1']['hanwhaMailaddr1'] = "";
    $_SESSION['dataForm1']['hanwhaMailaddr2'] = "";
    $_SESSION['dataForm1']['hanwhaMailPostal'] = "";
    if(!isset($user_data['birthDate'])){
        header("Location: ../../purchase/prepurchase?view=predata-input");
    }
?>
            ...
            <div class="col-12 col-md-8 formCol">
                <div class="row rowpaddingless existingUser">
                    ...
                    <form class="col-12" action="prepurchase?view=payment&existing=1" method="POST" id="" class="formCol">
                        ...
                        <div id="addBenef2" class="removeables">
...
<script>
    $('#selectorAhliWaris1').change(function(){
        $.ajax({
            ...
            data: "ahliwaris=" + $("#selectorAhliWaris1").val() + "&ctrbenef=1&reload=true",
            type: "get",
