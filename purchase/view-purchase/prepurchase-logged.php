...
<div class="row" style="margin-bottom: 20px;">
            ...
            <div class="col-12 col-md-8 formCol">
                <div class="row rowpaddingless">
                    ...
                    <h5>Jika anda membeli untuk diri sendiri silahkan <a href="prepurchase?view=self">klik disini</a></h5>
                    <form class="col-12 pt-5" action="prepurchase?view=search-user" method="POST" id="" class="formCol">
                        <div class="col-md-12 col-12 align-self-center formCol rowpaddingless">
                            <div class="row rowpaddingless">
                                <div class="col-12 rowpaddingless">
                                    <h5>Jika anda membeli untuk orang lain,<br>silahkan masukkan NIK dan Email calon pemegang Polis.</h5>
                                    <?php 
