              ...
              <div id="form6" class="container containerform animated fadeInRight" style="padding: 5% 0">
                <div class="row">
                  <div class="col-md-12 col-12 align-self-center">
                    ...
                    <div class="col-lg-10 col-md-12 col-12 displayDesktop" src="../assets/images/form/steps/step-06.png" width="100%"><img src="../assets/images/form/steps/step-06.png" width="100%"></div>
                        </div>
                        <img src="../assets/images/form/steps/step-06.png" width="100%" class="displayMobile">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-4 col-12 align-self-center">
                        <label for="referralcode" style="display: inline-block; margin-right: 1%;">Gunakan Kode Referral</label>
                        <input type="text" class="txedit" name="referralcode" placeholder="Referral Code" style="display: inline-block; width: 74%">
                        <div>
                            <ul>
                    ...
                    <label class="col-lg-4 col-md-4 col-12 align-self-center" id="bankOptions">
                        ...
                        <img src="/assets/images/banklogo/0912387.png" width="100%">
                    </label>
                    <?php } ?>
                    <label class="col-lg-6 col-md-4 col-12 align-self-center" id="bankOptions">
                        <input type="radio" class="option-input" name="paymentbank" value="009" required checked>
                        <img src="/assets/images/banklogo/18283.png" width="100%">
                    </label>
                    <label class="col-lg-6 col-md-4 col-12 align-self-center" id="bankOptions">
                        <input type="radio" class="option-input" name="paymentbank" value="013" required>
                        <img src="/assets/images/banklogo/1239.png" width="100%">
                    </label>
                </div>  
