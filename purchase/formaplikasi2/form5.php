	      ...
	      <div class="col-md-12 col-12 align-self-center judul">
		    <div class="step" style="margin-bottom: 2%">
                <div class="row" style="padding: 0px !important; margin: 0px !important; display: -webkit-box;">
                    ...
                    <div class="col-lg-10 col-md-12 col-12 displayDesktop" src="../assets/images/form/steps/step-05.png" width="100%"><img src="../assets/images/form/steps/step-05.png" width="100%"></div>
                </div>
                <img src="../assets/images/form/steps/step-05.png" width="100%" class="displayMobile">
