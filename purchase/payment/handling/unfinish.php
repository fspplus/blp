    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 col-12 align-self-center">
        <div class="step" style="margin-bottom: 2%; text-align:center;">
          ...
          <p>Maaf, pembayaran yang anda lakukan gagal. Coba beberapa saat lagi, atau hubungi CS kami di <a href="mailto:care@hanwhalife.co.id">care@hanwhalife.co.id</a>. Terima kasih</p>
          <br><br>
