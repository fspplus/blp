<?php //header('Location: /clientloginarea/userarea/') ?>
<?php 
session_start();
    if($_GET['error'] == 1){
    ...
    if(isset($_SESSION['email']) || $_SESSION['email'] != NULL || $_GET['key'] == NULL){
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" sizes="16x16" href="../clientloginarea/assets/images/favicon.png?v=2">
    ...
    <div class="row" style="margin: 0px;">
        <div class="col-md-12 col-12 align-self-center formLogin" style="padding: 0px;">
            ...
            <div class="formCol col-lg-6  col-md-12 col-12 align-self-center" style="margin-bottom: 0px;">
                <div class="switchEr"><a href="login" class="switchErBtn switchErActive">Kembali Login?</a></div>
