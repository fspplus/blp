                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12 addnew">
                                ...
                                <div style="display: inline-block;" class="btnDiv"><a href="<?php get_base_url(); ?>faqX?stat=newpost" class="btnAddNew">Add New</a></div>
                                <hr>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <?php
                                            	if ($status == "all" || $status == "") {
                                            		$sql = "SELECT * FROM `faq_table` LIMIT $startpage, $limitpage";
                                            		?><script>
                                            			$(function(){
                                            				$('#all').addClass("active");
                                            			});
                                            		...
                                            		$sql = "SELECT * FROM `faq_table` WHERE faq_status LIKE 'active' LIMIT $startpage, $limitpage";
                                            		?><script>
                                            			$(function(){
                                            				$('#act').addClass("active");
                                            			});
                                            		...
                                            		$sql = "SELECT * FROM `faq_table` WHERE faq_status LIKE 'inactive' LIMIT $startpage, $limitpage";
                                            		?><script>
                                            			$(function(){
                                            				$('#ict').addClass("active");
                                            			});
                                            ...
                                            ?>
                                                <tr>
                                                    <td ><input type="checkbox" name="selectObject" class="selectObject"><?php echo $data['faq_category']; ?></td>
