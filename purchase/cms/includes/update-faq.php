...
$postdata = array();
$postdata = get_post_faq($_GET['post']);
$postdata = $postdata[0];

//print_r($postdata[0]['faq_category']);


if($postdata["faq_question"] == NULL){
    ?><script>alert("Not Exist!"); window.location.href="/cms/faq"</script><?php
}
?>
        <form action="<?php get_base_url(); ?>/controller/upfaq?post=<?php echo $_GET['post']; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="formfaq">    
        <!-- MAIN CONTENT-->
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Question</strong> Edit
                                    </div>
                                    <div class="card-body card-block">
                                        <div>
                                            <div class="row form-group">
                                                <div class="col-12 col-md-12">
                                                    <h3>Editting Question: <?php echo $postdata['faq_question']; ?></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div>
                                            <div class="row form-group">
                                                <div class="col-12 col-md-12">
                                                    <input type="text" id="text-input" name="faq_question" placeholder="Question" class="form-control" required value="<?php echo $postdata['faq_question'] ?>">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div>
                                            <div class="row form-group">
                                                <div class="col-12 col-md-12">
                                                    <textarea name="faq_answer" id="textarea-input" rows="25" placeholder="Content..." class="form-control"><?php echo $postdata['faq_answers'] ; ?></textarea >
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-md-9">
                                                    <select name="faq_category" id="multiple-select"  class="form-control" multiple="">
                                                        <?php get_category($postdata['faq_category']); ?>
                                                    </select>
                                                </div>
                                            </div>
