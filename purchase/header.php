...
if(isset($_GET['get']) || isset($_COOKIE['status_hanwhasmart'])){
    if($_GET['get'] == "hanwhasmart" || $_COOKIE['status_hanwhasmart'] == "yes"){
        $_SESSION['status_hanwhasmart'] = "hanwhasmart";
    }
}
...
<head>
	...
	<!-- <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=5f5aeb140658220012f2d83a&product=inline-share-buttons" async="async"></script> -->
    ...
    <style>
        ...
        if(isset($_SESSION['status_hanwhasmart'])){
            if($_SESSION['status_hanwhasmart'] == "hanwhasmart"){
                echo ".header, .footer{display: none !important;}";
            }
        }
        ?>
    </style>
...
<body id="header2" class="fix-header fix-sidebar card-no-border">
	...
	<div class="header" style="padding-top: 0px !important;padding-bottom: 0px !important;">
		<a class="wa-chat" href="https://wa.me/<?=$phone?>?text=Hai,%20saya%20mau%20tau%20lebih%20banyak%20tentang%20bucketlist%20plan%20" target="_blank" rel="nofollow noopener noreferrer">
...
<?php
    if(isset($_GET['mode']) || isset($_SESSION['mode'])){
        if($_GET['mode'] == "app" || $_SESSION['mode'] == "app"){
            $_SESSION['mode'] = "app";
            ?>
                <style>
                    .header, .footer{
