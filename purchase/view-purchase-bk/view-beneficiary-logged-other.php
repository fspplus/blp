...
if(isset($_GET['ahliwaris'])){
    $dataspec = getspecific($_GET['memberId'], $_GET['ahliwaris']);
    $contain_benef = 1;
    if(isset($_GET['show'])){
        $contain_benef = 0;
    }
...
<div id="benef<?php echo $_GET['ctrbenef']; ?>" class="row rowpaddingless" style="width: 100%;">
    ...
    <div id="loggedAhliWaris<?php echo $_GET['ctrbenef']; ?>" class="row rowpaddingless">
        ...
        <div class="floating-label border-b-orange col-md-6 rowpaddingless">
            <input type="text" class="form-controller" name="hanwhadob<?php echo $_GET['ctrbenef']; ?>" placeholder="Tanggal Lahir" id="dateahliwaris<?php echo $_GET['ctrbenef']; ?>" onkeypress="return false" required value="<?php echo $dataspec['birthDate']; ?>">
...
<div id="addBenef<?php echo $_GET['ctrbenef']+1; ?>">
    ...
    <?php if($_GET['ctrbenef'] < 5 && $contain_benef != 1){ ?>
...
<script>   
    ...
    $('#selectorAhliWaris<?php echo $_GET['ctrbenef']; ?>').change(function(){
        $.ajax({
            ...
            data: "cont=yes&ahliwaris=" + $("#selectorAhliWaris<?php echo $_GET['ctrbenef']; ?>").val() + "&ctrbenef=<?php echo $_GET['ctrbenef']; ?>",
            type: "get",
