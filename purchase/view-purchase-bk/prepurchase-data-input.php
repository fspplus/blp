...
<div class="row" style="margin-bottom: 20px;">
            <div class="col-12">
                <h1 class="textorange"><strong>Paket Terpilih - Data 2</strong></h1>
            </div>
                        ...
                        <div class="col-md-12 col-12 align-self-center formCol rowpaddingless">
                            <div class="row rowpaddingless">
                                ...
                                <div class="floating-label border-b-orange col-md-6 rowpaddingless divEmail">
                                    <input type="email" class="form-controller dataEmail" name="hanwhaemail" placeholder="Alamat Email" value="<?php if($session_avail == FALSE || $sessionpart_avail == FALSE ){echo $_SESSION['dataForm1']['hanwhaemail'];} ?>"  required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
                                ...
                                <div class="floating-label border-b-orange col-md-6 rowpaddingless divPhone">
                                    <input type="tel" class="form-controller dataPhone" name="hanwhaphone" placeholder="No. Handphone" maxlength="13" value="<?php if($session_avail == FALSE){echo $_SESSION['dataForm1']['hanwhaphone'];} ?>" required>
    ...
    if($(".dataEmail").val() != ""){
        ...
        changeTimer = setTimeout(function(){
            $.ajax({
                 ...
                 data: 'email='+$(".dataEmail").val(), // appears as $_GET['id'] @ your backend side
    ...
    if($(".dataPhone").val() != ""){
        ...
        changeTimer = setTimeout(function(){
            $.ajax({
                 type: "GET",
                 url: "view-purchase/check-user.php",
                 data: 'phoneNum='+$(".dataPhone").val(), // appears as $_GET['id'] @ your backend side
                 success: function(dataSum) {
                       // data is ur summary
    ...
    if($(".dataNIK").val() != ""){
        ...
        changeTimer = setTimeout(function(){
            $.ajax({
                 type: "GET",
                 url: "view-purchase/check-user.php",
                 data: 'nik='+$(".dataNIK").val(), // appears as $_GET['id'] @ your backend side
                 success: function(dataSum) {
                       // data is ur summary
