<div id="benef<?php echo $_GET['ctrbenef']; ?>" class="row rowpaddingless" style="width: 100%;">
    ...
    <div class="col-md-6 radioSelector">
        <label><input type="radio" name="genderAhliWaris<?php echo $_GET['ctrbenef']; ?>" value="M"><span>Pria</span></label>
    </div>
    <div class="col-md-6 radioSelector">
        <label><input type="radio" name="genderAhliWaris<?php echo $_GET['ctrbenef']; ?>" value="F"><span>Wanita</span></label>
    </div>
    ...
    <div class="floating-label border-b-orange col-md-6 rowpaddingless">
        <input type="text" class="form-controller" name="hanwhadob<?php echo $_GET['ctrbenef']; ?>" placeholder="Tanggal Lahir" id="dateahliwaris<?php echo $_GET['ctrbenef']; ?>" onkeypress="return false" required>
