...
<head>
    ...
    <meta name="description" content="Untuk melihat halaman profile management dalam produk asuransi Hanwha Bucket list plan">
    <meta name="author" content="">
    <!-- Favicon icon -->
    <link rel="icon" sizes="16x16" href="../assets/images/favicon.png?v=2">
    <title>Bucketlistplan by Hanwha Life Insurance - Login</title>
    <!-- Bootstrap Core CSS -->
    ...
    <link href="/purchase/css/custom.css?v=<?php echo date('is'); ?>" rel="stylesheet">
    ...
    <div class="row" style="margin: 0px;">
        <div class="col-md-12 col-12 align-self-center formLogin" style="padding: 0px;">
            ...
            <div class="formCol col-lg-6  col-md-12 col-12 align-self-center">
                <!--<div class="switchEr"><a href="#apply-influencer" class="switchErBtn switchErActive">Dapatkan lebih!</a></div>-->
                <div class="formProcss"><?php include 'usepassform-agent.php'; ?></div>
            </div>
        </div>
    </div>
</body>
    ...
    $(function() {
         ...
         $(form).submit(function(event) {
             ...
             $.ajax({
                 type: 'POST',
                 method: 'POST',
                 url: "../controller/loginagent-proc.php",
                 data: form.serialize(),
     ...
     $(".view-password").on("click", function(){
        if($(".password-inputter").attr("type") == "password"){
            $(".password-inputter").attr("type", "text");
        }else if($(".password-inputter").attr("type") == "text"){
            $(".password-inputter").attr("type", "password");
        }
        console.log($(".password-inputter").attr("type"));
     })
</script>