...
<head>
    ...
    <link href="/css/styler-new.css?ver=<?php echo rand(); ?>" rel="stylesheet">
    <link href="/css/custom.css?ver=<?php echo date("h:i:sa"); ?>" rel="stylesheet">
                    		...
                    		<li class="listMenuLists sub" style="width: 350px; margin-left: -200px; padding: 8px 35px;">
                                <div class="row noPads displayDesktop" style="margin: 10px 0px; padding: 0px !important;">
                                    ...
                                    <form class="loginheader" action="proc/loginpro.php" method="POST" id="formlogin">
                                        <h4 style="color:#ff7101; text-align:left;">LOGIN</h4>

                                       <div class="col-md-12 col-12 align-self-center">
                                            <div class="floating-label">
                                                <input type="email" name="hanwhaemail" placeholder="Email">
                                            ...
                                            <div class="floating-label">
                                                ...
                                                <input type="password" id="kvkpwd" name="hanwhapassword" placeholder="Password">
