...
class __TwigTemplate_f7571ecab180322230911c5531f0c65da2cac01edb2560a9f630a4c8390d4a36 extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
...
{{/ifCond}}";
    ...
    {
        return new Source("", "form/templatesLegacy/blocks/date.hbs", "/var/www/bucketlistplan.co.id/web/wp-content/plugins/mailpoet/views/form/templatesLegacy/blocks/date.hbs");
    }
}
