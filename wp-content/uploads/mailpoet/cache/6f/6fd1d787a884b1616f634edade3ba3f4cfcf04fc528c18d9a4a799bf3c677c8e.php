...
class __TwigTemplate_912a72fd93571ca6a3b80a92c154a1f51b0ed336fdf6f70a376264b220883387 extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <select name=\"params[validate]\">
    ...
    {
        return new Source("", "form/templatesLegacy/settings/validate.hbs", "/var/www/bucketlistplan.co.id/web/wp-content/plugins/mailpoet/views/form/templatesLegacy/settings/validate.hbs");
    }
}
