...
class __TwigTemplate_2e6b2c52c9881b505b82e1336c6f10d22db5502f5c92516c7ae83c13789a5384 extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"inside\">
    ...
    <script id=\"new_segment_template\" type=\"text/x-handlebars-template\">
      ...
      <p class=\"mailpoet_align_right\">
        ...
        echo "\" id=\"new_segment_cancel\" class=\"mailpoet-button mailpoet-button-light\"/>
        <input type=\"submit\" value=\"";
        // line 29
        echo $this->extensions['MailPoet\Twig\I18n']->translate("Done");
        echo "\" id=\"new_segment_process\" class=\"mailpoet-button\"/>
      </p>
...
";
    ...
    {
        return new Source("", "subscribers/importExport/import/step_data_manipulation.html", "/var/www/bucketlistplan.co.id/web/wp-content/plugins/mailpoet/views/subscribers/importExport/import/step_data_manipulation.html");
    }
}
