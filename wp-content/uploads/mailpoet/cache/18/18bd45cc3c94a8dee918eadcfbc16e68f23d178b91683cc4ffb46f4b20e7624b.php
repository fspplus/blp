...
class __TwigTemplate_c36a603eb502082f75af9d4cba977e6160605853815d1c748081343ff0a4dfe3 extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
...
<{{!}}/script>";
    ...
    {
        return new Source("", "form/templatesLegacy/settings/segment_selection.hbs", "/var/www/bucketlistplan.co.id/web/wp-content/plugins/mailpoet/views/form/templatesLegacy/settings/segment_selection.hbs");
    }
}
