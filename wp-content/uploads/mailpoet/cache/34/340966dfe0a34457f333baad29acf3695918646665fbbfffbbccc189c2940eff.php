...
class __TwigTemplate_efe889e85990a5026e710778682a8980f66977338fe6e2663183a9eb62f21891 extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
      ...
      \$('#form_field_new').parsley().on('form:submit', function(parsley) {
        ...
        MailPoet.Ajax.post({
          ...
          if(data.id) {
            MailPoet.Notice.success(
              \"";
        // line 99
        echo \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_escape_filter($this->env, $this->extensions['MailPoet\Twig\I18n']->translate("Updated custom field %\$1s"), "js"), "html", null, true);
        echo "\".replace('%\$1s', '\"' + encodeHtmlValue(data.name) + '\"')
            ...
            MailPoet.Notice.success(
              \"";
        // line 103
        echo \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_escape_filter($this->env, $this->extensions['MailPoet\Twig\I18n']->translate("Added custom field %\$1s"), "js"), "html", null, true);
        echo "\".replace('%\$1s', '\"' + encodeHtmlValue(data.name) + '\"')
            );
          }
...
";
    ...
    {
        return array (  177 => 103,  170 => 99,  129 => 61,  118 => 53,  108 => 46,  100 => 41,  93 => 37,  86 => 33,  79 => 29,  72 => 25,  65 => 21,  57 => 16,  49 => 11,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "form/templatesLegacy/settings/field_form.hbs", "/var/www/bucketlistplan.co.id/web/wp-content/plugins/mailpoet/views/form/templatesLegacy/settings/field_form.hbs");
    }
}
