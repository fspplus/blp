<?php 
    ...
    if($otpstats['result_code'] == 1105){
        ...
        header("Location: ../signup?err=1100");
    }
    // print_r($otpstats[0]['result_code']);
?>
    ...
    <div class="col-md-12 col-12 align-self-center">
        <div style="color: white">
            ...
            <?php 
                if($addNotifstring == ""){
                    ?>
                    Masukkan kode OTP yang diterima di <?php echo $statusPhoneMail; ?> anda. Jika belum, silahkan klik coba kembali
                    <?php 
                }else{
                    echo $addNotifstring;
                }
        ...
        <?php if($otpstats['result_code'] != 1104){ ?>
            ...
            <div class="row" style="padding: 0px;">
                ...
                <div class="row" style="padding: 10px 0px;"><a href="javascript:void(0)" onclick="window.location.reload()">Coba Kembali</a></div>
